...
const DEFAULT_FROM_EMAIL = process.env.EMAIL_FROM || process.env.GMAIL_USER || "no-reply@scramblurr.com";
...
async function getAccessToken() {
  ...
  if (!tokenValue) {
    throw new Error("Failed to obtain access token. Check your OAuth credentials.");
  }
